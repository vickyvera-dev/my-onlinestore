...
<span className="font-medium text-gray-500">/ Category</span>
        ...
        <div className="bg-gray-100 py-4 w-full">
          <div className="flex lg:flex-row flex-col lg:gap-0 justify-between lg:items-center  max-w-7xl px-4 ">
            <h1 className="font-bold text-2xl text-blue-900 lg:ml-[8%]">
              Category
            </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-2 max-w-7xl mx-auto pt-6 w-full">
        {/* Left Sidebar */}
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex flex-col lg:flex-row lg:gap-4 gap-3 items-center">
              <div className="w-full">
                <label className="font-medium text-blue-900 mb-2 text-sm">
                  Search Products
                </label>
              ...
              <div className="flex flex-row gap-4 items-center w-full lg:w-[40%]">
                <div>
                  ...
                  <div className="p-2 rounded-md bg-blue-600 flex items-center justify-center">
                    <Grid3X3
                      size={28}
                      stroke="blue"
                      fill="white"
                ...
                <div className="p-2 rounded-md border-gray-300 border hover:border-blue-600 flex items-center justify-center mt-6">
                  <List
                    size={28}
                    stroke="gray"
                    fill="white"
            ...
            <div className="border-t-gray-300 mt-15 pt-4 border-t-1 mb-8">
              <div className="flex gap-2 items-center justify-between flex-wrap">
                <div className="flex gap-2 items-center flex-wrap lg:flex-row">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <button className="text-sm font-medium py-1 px-4 text-blue-600 bg-blue-100 rounded-full flex items-center gap-2">
                      Electronics
                      <span className="rounded-full hover:bg-blue-300 p-1">
                        <X size={15} strokeWidth={0.7} />
                      </span>
                    </button>
                    <button className="text-sm font-medium py-1 rounded-full px-4 text-blue-600 bg-blue-100 flex items-center gap-2">
                      $50 to $100
                      <span className="rounded-full hover:bg-blue-300 p-1">
                        <X size={15} strokeWidth={0.7} />
                      </span>{" "}
                ...
                <button className="text-blue-600 font-bold border border-blue-200 rounded-full bg-blue-50 py-2 px-4 float-end text-sm hover:border-blue-600 transition-colors ease-in-out delay-300">
                  <a href="#">Clear All</a>
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 w-full max-w-7xl mx-auto mt-10">
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:-translate-y-1 transition-all relative group overflow-hidden">
              <div className="relative">
                ...
                <div className="absolute z-50 top-3 right-3 flex gap-2 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                  <button className="p-2 bg-white hover:bg-blue-600 rounded-full shadow hover:text-white">
                    <Heart size={20} />
                  </button>
                  <button className="p-2 bg-white hover:bg-blue-600 rounded-full shadow hover:text-white">
                    <RefreshCcw size={20} />
                ...
                <img
                  ...
                  className="w-full rounded-t-2xl group-hover:scale-105 transition"
                />

                <div className="absolute z-50 bottom-4 left-1/2 -translate-x-1/2 w-full flex justify-center opacity-0 lg:group-hover:opacity-100 transition-opacity">
                  <button className="py-3 px-8 bg-blue-600 text-white text-lg rounded-2xl w-[90%]">
                    Add to Cart
                  </button>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:-translate-y-1 transition-all relative group overflow-hidden">
              <div className="relative">
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 opacity-0 lg:group-hover:opacity-100 transition w-full flex justify-center">
                  <button className="py-3 px-8 bg-blue-600 text-white text-lg rounded-xl w-[90%]">
                    Add to Cart
                  </button>
                </div>
              </div>
              ...
              <div className="p-4">
                ...
                <p className=" mt-8 flex flex-row gap-2">
                  <span className="line-through text-gray-400">$199.99</span>
                  <span className="font-medium text-[#dc2626]">$139.99</span>
                </p>
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:-translate-y-1 transition-all relative group overflow-hidden">
              <div className="relative">
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 opacity-0 lg:group-hover:opacity-100 transition w-full flex justify-center">
                  <button className="py-3 px-8 bg-blue-600 text-white text-sm rounded-2xl w-[90%] cursor-not-allowed opacity-40">
                    Sold Out
                  </button>
                </div>
              </div>
