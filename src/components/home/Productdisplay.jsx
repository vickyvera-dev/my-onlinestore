          ...
          {items.map((item) => (
            <div key={item.id} className="px-1 lg:px-2 sm:px-1 md:px-3">
              <div  className=" w-full flex justify-center">
                <div
                data-aos="zoom-in"
                className="bg-gray-100 rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-500 ease-in-out hover:-translate-y-2 lg:w-[90%] sm:w-[70%] md:w-[80%]"
              >
                <img
                  src={item.image}
                  alt={item.name}
