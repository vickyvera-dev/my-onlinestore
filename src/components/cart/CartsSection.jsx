...
import { BsApple, BsArrowLeft, BsArrowRight, BsCreditCard2Front, BsFillTrashFill, BsGoogle, BsPaypal, BsWallet2 } from "react-icons/bs";
    ...
    <div className="w-full bg-gray-50">
      ...
      <div className="bg-gray-100 py-4 w-full">
        <div className="flex justify-between items-center px-10 max-w-7xl">
          <h1 className="font-bold text-2xl text-blue-900 ml-[8%]">Cart</h1>
          <div className="flex gap-2">
            <Link to="/" className="font-medium text-blue-600 cursor-pointer">
              Home
            </Link>
            <span className="font-medium text-gray-500">/ Cart</span>
          </div>
        </div>
      </div>
...
<div className="flex flex-row justify-between border border-gray-300 transition-all ease-in-out duration-300 hover:border-blue-600 p-4 rounded-2xl">
  ...
  <div>
    <div className="w-full mb-3 flex flex-col lg:flex-row gap-3 py-4 items-center ml-2">
      ...
      <div className="flex flex-col gap-3 text-left">
        <span className="text-gray-600 font-medium hover:text-blue-600">Lorem ipsum dolor sit amet</span>

        <span className="flex flex-row gap-3">
          <span className="border border-gray-200 py-1 px-3 rounded">Color: Black</span>
          <span className="border border-gray-200 py-1 px-3 rounded">Size: M</span>
        </span>
        ...
        >
          <BsFillTrashFill size={17} className="text-gray-500 group-hover:text-red-600" />
          <span className="text-gray-500 group-hover:text-red-600">Remove</span>
        </span>
      </div>
    </div>
  </div>
  ...
  <div className="flex flex-wrap flex-row gap-8 items-center mr-4">
        ...
        <span className="flex flex-row lg:gap-4 md:gap-3 gap-2  items-center py-1 l:px-5 md:px-3 px-3  rounded-full border border-gray-300">
          ...
          <p className="font-medium text-gray-700 text-lg">{quantityshirt}</p>
        ...
        <div className="pb-2 flex flex-col">
          <p className="relative inline-block after:content-[''] after:absolute after:left-0 after:-bottom-1 after:w-full after:h-[3px]
               after:bg-[linear-gradient(to_right,rgba(0,0,255,0.7),transparent)] after:rounded-full text-lg text-gray-600 pb-2 font-bold">$129.98</p>
        </div>
      </div>
</div>
      )}
      ...
      <div className="flex  flex-row justify-between border border-gray-300 transition-all ease-in-out duration-300 hover:border-blue-600 p-4 rounded-2xl">
        ...
        <div>
          <div className="w-full mb-3 flex flex-col lg:flex-row gap-3 py-4 items-center ml-2">
            ...
            <div className="flex flex-col gap-3 text-left">
              <span className="text-gray-600 font-medium hover:text-blue-600">Consectetur adipiscing elit</span>

              <span className="flex flex-row gap-3">
                <span className="border border-gray-200 py-1 px-3 rounded">Color: White</span>
                <span className="border border-gray-200 py-1 px-3 rounded">Size: L</span>
              </span>
        ...
        <div className="flex flex-row gap-8 items-center mr-4 flex-wrap">
              ...
              <span className="flex flex-row lg:gap-4 md:gap-3 gap-2  items-center py-1 l:px-5 md:px-3 px-3 rounded-full border border-gray-300">
                ...
                <p className="font-medium text-gray-700 text-lg">{quantitychair}</p>
      ...
      <div className="flex flex-row justify-between border border-gray-300 transition-all ease-in-out duration-300 hover:border-blue-600 p-4 rounded-2xl">
        ...
        <div>
          <div className="w-full mb-3 flex flex-col lg:flex-row gap-3 py-4 items-center ml-2">
            ...
            <div className="flex flex-col gap-3 text-left">
              <span className="text-gray-600 font-medium hover:text-blue-600">Sed do eiusmod tempor</span>

              <span className="flex flex-row gap-3">
                <span className="border border-gray-200 py-1 px-3 rounded">Color: Blue</span>
                <span className="border border-gray-200 py-1 px-3 rounded">Size: S</span>
              </span>
        ...
        <div className="flex flex-row gap-8 items-center mr-4 flex-wrap">
              ...
              <span className="flex flex-row lg:gap-4 md:gap-3 gap-2  items-center py-1 lg:px-5 md:px-3 px-3 rounded-full border border-gray-300">
                ...
                <p className="font-medium text-gray-700 text-lg">{quantity}</p>
          ...
          <div className="flex flex-wrap flex-row items-center justify-between pb-4">            
              ...
              <span className="flex flex-row gap-4 items-center  rounded-full ">
                 <span className="flex flex-row gap-2 items-center group border border-gray-300 rounded py-1 px-3">
                     <MdOutlineUpdate  size={17} className="text-gray-500 transition-transform ease-in-out duration-300 group-hover:text-blue-600 group-hover:rotate-45"/> 
               ...
               <div className="group">
                 <span className="flex flex-row gap-2 items-center  border border-gray-300 rounded py-1 px-3 group-hover:bg-red-600">
                    <BsFillTrashFill size={17} className="text-gray-500 transition-transform ease-in-out duration-300 group-hover:text-white group-hover:rotate-45"/>
                    <span className="text-gray-500 transition-transform ease-in-out duration-300 group-hover:text-white">Remove</span>
                  </span>     </div>                          
              </span>
        ...
        <div className="flex flex-col gap-4 px-4 shadow-lg border-t-6 rounded-2xl border-t-blue-500">
          ...
          <div className="flex flex-row justify-between items-center mt-3">
            <span>Subtotal</span>
            <span className="transition-all ease-in-out duration-300 hover:translate-x-2 font-bold">$269.96</span>
          </div>
          ...
          <div className="flex flex-row gap-4">
            ...
            <div className="flex flex-col space-y-3">
              ...
              >
                ...
                <span className="text-gray-600 hover:text-blue-600">Standard Delivery - $4.99</span></div>
              ...
              </div><span className="text-gray-600 hover:text-blue-600">Express Delivery - $12.99</span></div>
              ...
              <span className="text-gray-600 hover:text-blue-600">Free Shipping (Orders over $300)</span></div>
            </div>
          </div>

          <div className="flex flex-row justify-between items-center mt-4">
            <span>Tax</span>
            <span className="transition-all ease-in-out duration-300 hover:translate-x-2 font-bold py-1 px-5 rounded-full bg-blue-50">$27.00</span>
          </div>
          ...
          <div className="flex flex-row justify-between items-center">
            ...
            <span className="transition-all ease-in-out duration-300 hover:translate-x-2 py-1 px-5 rounded-full bg-blue-100 font-bold">-$0.00</span>
          </div>
...
after:bg-[linear-gradient(to_right,rgba(0,0,255,0.7),transparent)] after:rounded-full font-bold text-2xl">
            ...
            <a href="#" className="text-white py-3 px-8 rounded-full bg-blue-600 text-center flex flex-row gap-2 transition-all ease-in-out duration-300 hover:-translate-y-2 items-center justify-center font-bold mt-4"><span>Proceed to check </span><span><BsArrowRight/></span></a>

            <div>
              <a href="#" className="text-blue-600 py-3 px-8 rounded-full bg-blue-100 text-center flex flex-row gap-2 transition-all ease-in-out duration-300 hover:-translate-y-2 items-center justify-center"><span><BsArrowLeft/></span><span>Continue Shopping</span></a>
            </div>
          <div className="flex flex-col gap-3 items-center justify-center mt-6">
            <span className="text-gray-500">We Accept</span>
            <div className="flex flex-row gap-3">
              <span className="text-gray-400 transition-all ease-in-out duration-300 hover:-translate-y-1 hover:text-blue-600"><BsCreditCard2Front size={26} /></span>
              <span  className="text-gray-400 transition-all ease-in-out duration-300 hover:-translate-y-1 hover:text-blue-600"><BsPaypal size={26} /></span>
              <span  className="text-gray-400 transition-all ease-in-out duration-300 hover:-translate-y-1 hover:text-blue-600"><BsWallet2  size={26} /></span>
              <span  className="text-gray-400 transition-all ease-in-out duration-300 hover:-translate-y-1 hover:text-blue-600"><BsApple size={26} /></span>
              <span  className="text-gray-400 transition-all ease-in-out duration-300 hover:-translate-y-1 hover:text-blue-600"><BsGoogle size={26} /></span>
            </div>
          </div>
        </div>
      </div>
